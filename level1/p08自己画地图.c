...
void getmate_3();
void print_mate();
void move(char move,int current_line,int current_column);
void gametime(int current_line,int current_column);
...
int mate_3[11][11]={
    ...
    {0,1,2,2,2,0,2,2,2,2,0},//2
    {0,2,3,3,2,2,2,0,2,2,0},//3
    {0,2,0,0,2,0,2,0,0,2,0},//4
    {0,2,2,2,2,4,2,2,2,2,0},//5
    {0,0,2,0,4,0,4,0,2,0,0},//6
    {0,2,2,2,2,4,2,2,2,2,0},//7
    {0,2,0,0,2,0,2,0,0,2,0},//8
    {0,2,2,0,2,2,2,3,3,2,0},//9
    {0,2,2,2,2,0,2,2,2,2,0},//10
...
void getmate_3(){
    flag=3,current_Line=1,current_Column=1;
    ...
    switch(Move){
        case 'a':
            switch(mate[current_line][current_column-1]){
                case '0'||'4'||'5'||'6': move(getch(),current_line,current_column);break;
                case '2':mate[current_line][current_column]='2',mate[current_line][current_column-1]='1';current_Column--;break;
                //case '4':mate[current_line][current_column]='4',mate[current_line][current_column]='1';break;
                case '3':
                    switch(mate[current_line][current_column-2]){
                        ...
                        case '0'||'5'||'6':move(getch(),current_line,current_column);break;
        ...
        default :move(getch(),current_line,current_column);
    }
}
void gametime(int current_line,int current_column){
...
int main(){
    ...
    getmate_1(),gametime(2,1);
    getmate_2(),gametime(3,1);
    getmate_3(),gametime(1,1);
    return 0;
}